...
const OrgDeleteProfile = () => {
  ...
  console.log(profileMain, profileLoading, profileAppErr, profileServerErr);
  ...
  const { userDetails, appErr, serverErr, loading, isDeleted } = users;
  if (isDeleted) return <Navigate to={`/organization/profile`} />;
  return (
    <div>
