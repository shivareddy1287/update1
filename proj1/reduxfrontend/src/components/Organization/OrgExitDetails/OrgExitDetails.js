                ...
                <tbody>
                  {exitDetailsList?.map((exitDetailsEach) => (
                    <tr key={exitDetailsEach?.id}>
                      ...
                      <td>
                        <Link
                          to={`/organization/exitdetails/update/${exitDetailsEach?.id}`}
                        >
                          Edit
                        </Link>
                      </td>
                      <td>
                        <Link
                          to={`/organization/exitdetails/delete/${exitDetailsEach?.id}`}
                        >
                          Delete
                        </Link>
                      </td>
                      <td>
                        <Link
                          to={`/organization/exitdetails/view/${exitDetailsEach?.id}`}
                        >
                          View
                        </Link>
                      </td>
