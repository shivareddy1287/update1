...
const OrgDeleteAsset = () => {
  ...
  // console.log(singleAsset, isDeleted, loading, appErr, serverErr);
  ...
  if (isDeleted) return <Navigate to={`/organization/asset`} />;
                ...
                <div className="cs_edit_left_right_div">
                  ...
                  <div className="cs_edit_left_input_right_input">
                    ...
                    <div className="cs_edit_input_div">
                      ...
                      <h1 className="cs_view_right_input">{returnDate}</h1>
                    </div>
                  </div>
                </div>
              </div>
