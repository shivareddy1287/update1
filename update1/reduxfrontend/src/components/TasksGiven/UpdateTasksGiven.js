...
const UpdateTasksGiven = () => {
  ...
  const { singleTasksGiven, isTasksGiveneUpdated } = tasks;
  ...
  if (isTasksGiveneUpdated) return <Navigate to={`/tasks/tasks-given`} />;
        ...
        <form onSubmit={formik.handleSubmit} className="cs_edit_div">
          <div>
            ...
            >
              ...
              <div>
                <h2 className="cs_edit_employee_head"> Edit Tasks</h2>
              </div>
            </Link>
          </div>
